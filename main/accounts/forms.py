...
class MyLoginForm(forms.Form):
    captcha = ReCaptchaField()
    telephone = forms.CharField(label='Телефон', max_length=50, required=True)
    password = forms.CharField(label='Пароль', max_length=50, required=True)
...
class PasswordField(forms.CharField):
    def __init__(self, *args, **kwargs):
        ...
        kwargs["widget"] = forms.PasswordInput(
            ...
            attrs={"placeholder": kwargs.get("label"), "class": 'login__input login_pass'},
        )
...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username"), "autocomplete": "username", "class": "login__input"}
            )
            ...
            login_widget = forms.TextInput(
                attrs={"class": "login__input", "placeholder": _("Username or e-mail"), "autocomplete": "email"}
            )
            login_field = forms.CharField(
...
class BaseSignupForm(_base_signup_form_class()):
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Имя пользователя", "autocomplete": "username", 'class': 'login__input'}
        ),
    )
    # captcha = ReCaptchaField()
    ...
    def __init__(self, *args, **kwargs):
        ...
        if email_required:
            self.fields["email"].label = gettext("")
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.SIGNUP_PASSWORD_ENTER_TWICE:
            self.fields["password2"] = PasswordField(label="")
...
class SocialDisconnectForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(SocialDisconnectForm, self).__init__(*args, **kwargs)
        self.fields["account"].queryset = self.accounts

    def clean(self):
        cleaned_data = super(SocialDisconnectForm, self).clean()
